...
/**
 * zynthex Solana Program Configuration
 * 
 * Program deployed on Solana Testnet
 * Deploy Platform: Solana Playground
 */

// zynthex Program ID (deployed on Solana Testnet)
export const zynthex_PROGRAM_ID = new PublicKey(
...
export enum zynthexInstruction {
